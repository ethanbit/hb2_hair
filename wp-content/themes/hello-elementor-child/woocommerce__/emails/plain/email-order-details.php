...
echo wp_kses_post( strtoupper( sprintf( __( 'Request number: %s', 'woocommerce' ), $order->get_order_number() ) ) ) . "\n";
...
if ( $sent_to_admin ) {
	...
	echo "\n" . sprintf( esc_html__( 'View Request: %s', 'woocommerce' ), esc_url( $order->get_edit_order_url() ) ) . "\n";
}
