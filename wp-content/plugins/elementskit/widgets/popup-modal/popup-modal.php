        ...
        <!-- Start Markup -->
            ...
            <?php elseif($toggler_type == 'button'): ?>
                <div class='ekit-popup-modal__toggler-wrapper'>
                    ...
                    <button 
                        type="button" 
                        class="elementskit-btn ekit-popup-btn ekit-popup-btn__filled ekit-popup__toggler ekit-popup-modal-toggler" 
                        data-toggle="modal" 
                            ...
                            <div 
                                ...
                                <?php if($show_footer_close == "yes"): ?>
                                    <span>
                                        <a 
                                            href="#" 
                                            class="elementskit-btn ekit-popup-btn ekit-popup-footer__close <?php echo $footer_close_type ?>"
                                ...
                                <?php if($show_footer_cta == "yes"): ?>
                                    <span>
                                        <a 
                                            ...
                                            class="elementskit-btn ekit-popup-btn ekit-popup__cta <?php echo $footer_cta_type ?>"
